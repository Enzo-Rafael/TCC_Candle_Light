...
//     version 1.13.1
//     from Assets/Scriptis/ImputSystem/PlayersInputMap.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scriptis/ImputSystem/PlayersInputMap.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayersInputMap: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_UIInputs_EscInput = m_UIInputs.FindAction("EscInput", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_UIInputs_EscInput;
    /// <summary>
    ...
    public struct UIInputsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "UIInputs/EscInput".
        /// </summary>
        public InputAction @EscInput => m_Wrapper.m_UIInputs_EscInput;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
